package jrkim.rcash.ui.component.ProgressButton;
...
public class FlatButton extends AppCompatButton {
    ...
    private LayerDrawable createNormalDrawable(TypedArray attr) {
        ...
        int blueDark = getColor(R.color.blackThemeBlueGrey);
        ...
        int blueNormal = getColor(R.color.colorBlue);
    ...
    private Drawable createPressedDrawable(TypedArray attr) {
        ...
        int blueDark = getColor(R.color.blackThemeBlue);
        int colorPressed = attr.getColor(R.styleable.FlatButton_pb_colorPressed, blueDark);
